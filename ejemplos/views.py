...
from ejemplos.models import Proveedor, Product, Producto, Categoria, Proyecto
...
def ejemplos_proyect_edit_save(request):
    if request.method == 'POST':
        ...
        producto = Producto.objects.get(pk=id)#carga el proyecto que usaremos para muchos a muchos
        #actualizmos autores
